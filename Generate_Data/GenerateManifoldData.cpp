		 ...
		 int nrhs, const mxArray *prhs[])
{
  ...
  //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  // choice of dataset
  // 0: 1d sinusoid over the circle with high curvature in 3 dimensions
  // 1: a D-1 dimensional sphere (uniformly sampled) in D dimensions
  // 2: a 3d-affine space in 5 dimensions
  // 3: a strange 4d figure in 6d (but very concentrated so it is ess 3d)
  // 4: a 4d manifold in 8 dimensions
  // 5: a 2d helix in 3 dimensions
  // 6: a 6d manifold in 36 dimensions
  // 7: 2d "swiss roll" in 3 dimensions
  // 8: 12-dimensional manifold in 72 dimensions
  // 9: a 20d affine space in 20 dimensions
  //10: D-1 hypercube, uniformly sampled in D dimensions by padding w/ 0s
  //11: 2d Moebius band in 3 dimensions
  //12: D-dimensional Multivariate Gaussian in D dimensions
  //13: 1d curve in D dimensions
  ...
  switch(data_set)
  {
    case 0:  //generates a (slightly distorted) sinusoid over the circle in R^3
     ...
     case 1:  // generates a k-sphere  (uniformly sampled)
      ...
      mexPrintf("Generated %i data points of a %i - dimensional sphere in R^%i\n",num,dim-1,dim);
    ...
    case 2: // generates a 3d affine space in 5 dimensions
      dim=5;
    ...
    case 10: // generates a k-hypercube
      ...
      mexPrintf("Generated %i data points of a %i dimensional hypercube R^%i\n",num,dim-1,dim);
      mexPrintf("The correct dimension of this submanifold is %i\n",dim-1);
    ...
    case 11: //generates a moebius-band in 3d
      ...
      mexPrintf("Generated %i data points of a 10 times twisted moebius strip in R^3\n",num);
      mexPrintf("The correct dimension of this submanifold is 2\n");
    ...
    case 12: // generate a multivariate Gaussian
      ...
      mexPrintf("Generated %i data points of a %i dimensional Gaussian distribution with unit variance in R^%i\n",num,dim,dim);
      mexPrintf("The correct dimension of this submanifold is %i\n",dim);
    ...
    case 13:  //generates a one-dimensional curve in dim dimensions
      ...
      mexPrintf("Generated %i data points of a curve in R^%i\n",num,dim);
      mexPrintf("The correct dimension of this submanifold is 1\n");
      delete phi;
      break;
