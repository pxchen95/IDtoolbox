...
Dimension Reduction toolbox. I'm not sure how much I trust this toolbox since the implementation of global PCA had a bug in it and it is hard to figure out exactly which sources he was following in writing the algorithms. Below, I cite my best guesses at which algorithm I think he was following. The full toolbox also includes dimension reduction and some denoising techniques.
